...
import { ArrowLeftIcon, User, FileText, Briefcase, GraduationCap, ChevronLeft, FolderIcon, Sparkles, ChevronRight, Share2Icon, DownloadIcon, EyeIcon, EyeOffIcon } from 'lucide-react'
            ...
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
              ...
              <div className='flex justify-between items-center mb-6 border-b border-gray-300 py-1' >
                <div className='flex items-center gap-2'>
                  <TemplateSecector selectedTemplate={resumeData.template} onChange={(template) => setResumeData((prev) => ({ ...prev, template }))} />
              ...
              <button onClick={()=> {toast.promise(saveResume(), {loading: "Saving...", success: "Resume saved successfully", error: "Failed to save resume"})}} className='bg-gradient-to-br from-green-100 to-green-200 ring-green-600 ring hover:ring-green-400 transition-all rounded-md px-6 py-2 mt-6 text-sm'>
                save Changes
              </button>
            </div>
          </div>
          ...
          <div className='lg:col-span-7 max-lg:mt-6'>
            <div className='relative w-full'>
              <div className='absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2'>
                ...
                <button onClick={changePublicStatus} className='flex items-center p-2 px-4 gap-2 text-xs bg-bradient-to-br from-purple-100 to-purple-200 text-purple-600 ring-purple-300 rounded-lg hover:ring transition-colors'>
                  {resumeData.public ? (
                ...
                <button onClick={handleDownload} className='flex items-center gap-2 px-6 py-2 text-xs bg-gradient-to-br from-green-100 to-green-200 text-green-600 rounded-lg ring-green-300 hover:ring transition-colors'>
