            ...
            <div className='flex items-center gap-2'>
                <label >
                    {data.image ? (
                        ...
                        <div className='inline-flex items-center gap-2 mt-5 text-slate-600 hover:text-shadow-amber-700 cursor-pointer'>
                            <User className='size-10 p-2.5 border rounded-full' />
                            upload user image 
                            {/* {irgjrigjrigj} */}
                        </div>
                    )}
                    <input type="file" accept='image/jpeg, image/png' onChange={(e) => handleChange('image', e.target.files[0])} hidden />
                </label>
