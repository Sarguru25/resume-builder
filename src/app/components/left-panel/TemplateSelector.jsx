...
const TemplateSelector = ({ selectedTemplate, onChange, panel = false }) => {
    ...
    /* PANEL MODE (Sidebar Layout) */

    if (panel) {
        return (
            <div className="lg:col-span-5 bg-white rounded-lg border border-gray-200 shadow-sm p-6 space-y-3">
    ...
    return (
        <div className='relative'>
            ...
            <button
                ...
                className='flex items-center gap-1 text-sm text-blue-600 bg-gradient-to-br from-blue-50 to-blue-100 ring-blue-300 hover:ring px-3 py-2 rounded-lg'
            >
                <Layout size={14} />
